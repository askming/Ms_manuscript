...
\title{A Study of Time Trend in Global Infant Mortality Rates: Regression with Autocorrelated Data}%\thanks{Grants or other notes
...
\keywords{Infant mortality rate \and Regression analysis \and Time series \and Autocorrelation}
...
Figure 3 to Figure 6 (see Appendix) show the country-wise time trends of the IMR by continent.
...
\label{fig:africa}       % Give a unique label
\end{figure}
...
\label{fig:asia}       % Give a unique label
\end{figure}
