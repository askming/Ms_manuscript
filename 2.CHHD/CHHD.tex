...
\def\Authors{Ming Yang\,$^{1}$, Dejian Lai\,$^{1,*}$}
...
{\bf Table \ref{Tab:02}} (lower) shows the output, and the resulting model is:
...
This is originally MY's thesis work for his master's of science (MS) degree at the University of Texas School of Public Health. Dr. DL is the chair of the dissertation committee. 
...
\begin{figure}[h]
\begin{center}
  \includegraphics[scale=0.5]{1overall.pdf}
\end{center}
...
\begin{figure}[H]
  \includegraphics[width=0.5\textwidth]{2us_ols1.pdf}
  \includegraphics[width=0.5\textwidth]{3us_ols2.pdf}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[scale=0.7]{4afarica.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[scale=0.7]{5asia.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[scale=0.7]{6europ.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
  \includegraphics[scale=0.7]{7america.pdf}
\end{center}
